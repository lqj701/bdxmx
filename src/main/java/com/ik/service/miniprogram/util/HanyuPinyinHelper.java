...
public class HanyuPinyinHelper {
    ...
    public static String toHanyuPinyin(String ChineseLanguage) {
        ...
        try {
            ...
            HanyuPinyinHelper.logger.error("不能转换拼音: ChineseLanguage = " + ChineseLanguage);
            System.out.println("字符不能转成汉语拼音");
        } catch (Exception exception) {
            HanyuPinyinHelper.logger.error("Pin Yin error: ChineseLanguage = " + ChineseLanguage);
            HanyuPinyinHelper.logger.error("Pin Yin error: ", exception.getMessage(), exception);
        }
        return hanyupinyin;
    }
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 17; i++) {
            Integer index = random.nextInt(HanyuPinyinHelper.randomString.length());
            builder.append(HanyuPinyinHelper.randomString.substring(index - 1, index));
        }
